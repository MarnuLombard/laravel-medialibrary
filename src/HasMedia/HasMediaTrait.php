...
trait HasMediaTrait
{
    ...
    {
        $this->getMedia($collectionName, [])->filter(function (Media $currentMediaItem) use($newMediaArray) {
    ...
    {
        return isset($this->deletePreservingMedia) ? $this->deletePreservingMedia : false;
    }
}